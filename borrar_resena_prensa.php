...
if (isset($_GET["id_votoVideojuego"])) {
    ...
    $sql = "SELECT AVG(nota) AS puntuacion_media FROM ResenasVideojuegos WHERE id_videojuego=? AND id_usuario IS NULL";
    $stmt = mysqli_prepare($conn, $sql);
    ...
    $sql = "UPDATE Videojuegos SET Nota_Prensa=? WHERE id_videojuego=?";
    $stmt = mysqli_prepare($conn, $sql);
    ...
    $sql = "SELECT AVG(nota) AS puntuacion_media FROM ResenasPeliculas WHERE id_pelicula=? AND id_usuario IS NULL";
    $stmt = mysqli_prepare($conn, $sql);
    ...
    $sql = "UPDATE Peliculas SET Nota_Prensa=? WHERE id_pelicula=?";
    $stmt = mysqli_prepare($conn, $sql);
