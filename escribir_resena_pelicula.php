...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          // Verifica si el usuario que ha iniciado sesión es admin
  ...
  <body>
    ...
    <div class="añadir_reseña">
      <form action="procesar_resena_pelicula.php" method="post">
      ...
      <br>
      <a href="inicio.php" class='btn btn-primary'>Volver atras</a><br>
    </div>
  </body>
