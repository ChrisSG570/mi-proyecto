          ...
          <div class="card bg-dark text-white" style="border-radius: 1rem;">
            <div class="card-body p-5 text-center">
              <div class="mb-md-5 mt-md-4 pb-5">
                <h2 class="fw-bold mb-2 text-uppercase">Login: Usuario</h2>
              ...
              <div>
                <p class="mb-0">No tienes cuenta? <a href="register-usuario.php"
                    class="text-white-50 fw-bold">Registrate!</a>
                </p><br>
              </div>

              <?php
              // Validación de los datos para pasarlos a inicio
              if (isset($_POST["inicio_sesion"]) && isset($_POST["usuario"]) && isset($_POST["contrasenia"])) {
                ...
                if ($mysqli->connect_error) {
                  ...
                  if ($fila = $resultado->fetch_assoc()) {
                    // Creo una sesión para almacenar si es admin o no y lo redirige al catalogo.php
                ...
                // Cada vez que entres al formulario del login, se cierra la sesion
